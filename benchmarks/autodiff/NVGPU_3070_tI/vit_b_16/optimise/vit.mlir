module {
  func.func @forward(%arg0: tensor<1x224x224x3xf32>) -> (tensor<1x1000xf32>) {
    ...
    %23 = tosa.conv2d %arg0, %0, %1 {dilation = array<i64: 1, 1>, pad = array<i64: 0, 0, 0, 0>, stride = array<i64: 16, 16>} : (tensor<1x224x224x3xf32>, tensor<768x16x16x3xf32>, tensor<768xf32>) -> tensor<1x14x14x768xf32>
    %25 = tosa.reshape %23 {new_shape = array<i64: 1, 196, 768>} : (tensor<1x14x14x768xf32>) -> tensor<1x196x768xf32>
    ...
    %inserted_slice_0 = tensor.insert_slice %25 into %inserted_slice[0, 1, 0] [1, 196, 768] [1, 1, 1] : tensor<1x196x768xf32> into tensor<1x197x768xf32>
    ...
    %68 = tosa.mul %62, %67 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %93 = tosa.mul %87, %92 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %123 = tosa.mul %117, %122 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %147 = tosa.mul %141, %146 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %177 = tosa.mul %171, %176 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %201 = tosa.mul %195, %200 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %231 = tosa.mul %225, %230 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %255 = tosa.mul %249, %254 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %285 = tosa.mul %279, %284 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %309 = tosa.mul %303, %308 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %339 = tosa.mul %333, %338 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %363 = tosa.mul %357, %362 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %393 = tosa.mul %387, %392 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %417 = tosa.mul %411, %416 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %447 = tosa.mul %441, %446 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %471 = tosa.mul %465, %470 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %501 = tosa.mul %495, %500 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %525 = tosa.mul %519, %524 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %555 = tosa.mul %549, %554 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %579 = tosa.mul %573, %578 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %609 = tosa.mul %603, %608 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %633 = tosa.mul %627, %632 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %663 = tosa.mul %657, %662 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
    ...
    %687 = tosa.mul %681, %686 {shift = 0 : i8} : (tensor<1x197x768xf32>, tensor<1x197x1xf32>) -> tensor<1x197x768xf32>
