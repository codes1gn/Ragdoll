...
module {
  ...
  ml_program.global private mutable @global67(dense<1.000000e+00> : tensor<4x12x197x64xf32>) : tensor<4x12x197x64xf32>
  ...
  ml_program.global private mutable @global18(dense<1.000000e+00> : tensor<4x12x197x64xf32>) : tensor<4x12x197x64xf32>
  ...
  func.func @forward(%arg0: tensor<4x3x224x224xf32>) -> tensor<4x1000xf32> {
    ...
    // insert here
    %global18_1 = tosa.reshape %40 {new_shape = array<i64: 4, 197, 12, 64>} : (tensor<4x197x768xf32>) -> tensor<4x197x12x64xf32>
    %global18_2 = tosa.transpose %global18_1, %11 : (tensor<4x197x12x64xf32>, tensor<4xi64>) -> tensor<4x12x197x64xf32>
    // ml_program.global_store @global18 = %40 : tensor<4x197x768xf32>
    ml_program.global_store @global18 = %global18_2 : tensor<4x12x197x64xf32>
    ...
    %global67_1 = tosa.reshape %96 {new_shape = array<i64: 4, 197, 12, 64>} : (tensor<4x197x768xf32>) -> tensor<4x197x12x64xf32>
    %global67_2 = tosa.transpose %global67_1, %11 : (tensor<4x197x12x64xf32>, tensor<4xi64>) -> tensor<4x12x197x64xf32>
    ml_program.global_store @global67 = %global67_2 : tensor<4x12x197x64xf32>
  ...
  func.func @dforward(%arg0: tensor<4x1000xf32>) -> tensor<4x3x224x224xf32> {
    ...
    %19 = ml_program.global_load @global18 : tensor<4x12x197x64xf32>
    ...
    // %21 = tosa.reshape %global67 {new_shape = array<i64: 4, 197, 12, 64>} : (tensor<4x197x768xf32>) -> tensor<4x197x12x64xf32>
    // %22 = tosa.transpose %21, %15 : (tensor<4x197x12x64xf32>, tensor<4xi64>) -> tensor<4x12x197x64xf32>
    %22 = ml_program.global_load @global67 : tensor<4x12x197x64xf32>
    ...
    %64 = tosa.mul %63, %14 {shift = 0 : i8} : (tensor<4x197x1xf32>, tensor<f32>) -> tensor<4x197x1xf32>
    %66 = tosa.mul %global574, %64 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %73 = tosa.add %68, %71 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %96 = tosa.mul %global550, %94 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %104 = tosa.add %99, %102 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %112 = tosa.matmul %global543, %108 : (tensor<48x197x197xf32>, tensor<48x197x64xf32>) -> tensor<48x197x64xf32>
    ...
    %121 = tosa.add %113, %119 : (tensor<48x197x197xf32>, tensor<48x197x1xf32>) -> tensor<48x197x197xf32>
    ...
    %142 = tosa.mul %global527, %140 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %150 = tosa.add %145, %148 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %173 = tosa.mul %global503, %171 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %181 = tosa.add %176, %179 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %189 = tosa.matmul %global496, %185 : (tensor<48x197x197xf32>, tensor<48x197x64xf32>) -> tensor<48x197x64xf32>
    ...
    %198 = tosa.add %190, %196 : (tensor<48x197x197xf32>, tensor<48x197x1xf32>) -> tensor<48x197x197xf32>
    ...
    %219 = tosa.mul %global480, %217 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %227 = tosa.add %222, %225 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %250 = tosa.mul %global456, %248 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %258 = tosa.add %253, %256 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %266 = tosa.matmul %global449, %262 : (tensor<48x197x197xf32>, tensor<48x197x64xf32>) -> tensor<48x197x64xf32>
    ...
    %275 = tosa.add %267, %273 : (tensor<48x197x197xf32>, tensor<48x197x1xf32>) -> tensor<48x197x197xf32>
    ...
    %296 = tosa.mul %global433, %294 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %304 = tosa.add %299, %302 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %327 = tosa.mul %global409, %325 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %335 = tosa.add %330, %333 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %343 = tosa.matmul %global402, %339 : (tensor<48x197x197xf32>, tensor<48x197x64xf32>) -> tensor<48x197x64xf32>
    ...
    %352 = tosa.add %344, %350 : (tensor<48x197x197xf32>, tensor<48x197x1xf32>) -> tensor<48x197x197xf32>
    ...
    %373 = tosa.mul %global386, %371 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %381 = tosa.add %376, %379 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %404 = tosa.mul %global362, %402 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %412 = tosa.add %407, %410 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %420 = tosa.matmul %global355, %416 : (tensor<48x197x197xf32>, tensor<48x197x64xf32>) -> tensor<48x197x64xf32>
    ...
    %429 = tosa.add %421, %427 : (tensor<48x197x197xf32>, tensor<48x197x1xf32>) -> tensor<48x197x197xf32>
    ...
    %450 = tosa.mul %global339, %448 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %458 = tosa.add %453, %456 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %481 = tosa.mul %global315, %479 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %489 = tosa.add %484, %487 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %497 = tosa.matmul %global308, %493 : (tensor<48x197x197xf32>, tensor<48x197x64xf32>) -> tensor<48x197x64xf32>
    ...
    %506 = tosa.add %498, %504 : (tensor<48x197x197xf32>, tensor<48x197x1xf32>) -> tensor<48x197x197xf32>
    ...
    %527 = tosa.mul %global292, %525 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %535 = tosa.add %530, %533 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %558 = tosa.mul %global268, %556 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %566 = tosa.add %561, %564 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %574 = tosa.matmul %global261, %570 : (tensor<48x197x197xf32>, tensor<48x197x64xf32>) -> tensor<48x197x64xf32>
    ...
    %583 = tosa.add %575, %581 : (tensor<48x197x197xf32>, tensor<48x197x1xf32>) -> tensor<48x197x197xf32>
    ...
    %604 = tosa.mul %global245, %602 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %612 = tosa.add %607, %610 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %635 = tosa.mul %global221, %633 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %643 = tosa.add %638, %641 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %651 = tosa.matmul %global214, %647 : (tensor<48x197x197xf32>, tensor<48x197x64xf32>) -> tensor<48x197x64xf32>
    ...
    %660 = tosa.add %652, %658 : (tensor<48x197x197xf32>, tensor<48x197x1xf32>) -> tensor<48x197x197xf32>
    ...
    %679 = tosa.mul %678, %14 {shift = 0 : i8} : (tensor<4x197x1xf32>, tensor<f32>) -> tensor<4x197x1xf32>
    %681 = tosa.mul %global198, %679 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %689 = tosa.add %684, %687 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %712 = tosa.mul %global174, %710 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %720 = tosa.add %715, %718 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %728 = tosa.matmul %global167, %724 : (tensor<48x197x197xf32>, tensor<48x197x64xf32>) -> tensor<48x197x64xf32>
    ...
    %737 = tosa.add %729, %735 : (tensor<48x197x197xf32>, tensor<48x197x1xf32>) -> tensor<48x197x197xf32>
    ...
    %758 = tosa.mul %global151, %756 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %766 = tosa.add %761, %764 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %789 = tosa.mul %global127, %787 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %797 = tosa.add %792, %795 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %805 = tosa.matmul %global120, %801 : (tensor<48x197x197xf32>, tensor<48x197x64xf32>) -> tensor<48x197x64xf32>
    ...
    %814 = tosa.add %806, %812 : (tensor<48x197x197xf32>, tensor<48x197x1xf32>) -> tensor<48x197x197xf32>
    ...
    %835 = tosa.mul %global104, %833 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %843 = tosa.add %838, %841 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %866 = tosa.mul %global80, %864 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %874 = tosa.add %869, %872 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %882 = tosa.matmul %global73, %878 : (tensor<48x197x197xf32>, tensor<48x197x64xf32>) -> tensor<48x197x64xf32>
    ...
    %891 = tosa.add %883, %889 : (tensor<48x197x197xf32>, tensor<48x197x1xf32>) -> tensor<48x197x197xf32>
    ...
    %912 = tosa.mul %global57, %910 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %920 = tosa.add %915, %918 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %943 = tosa.mul %global32, %941 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %951 = tosa.add %946, %949 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %959 = tosa.matmul %global25, %955 : (tensor<48x197x197xf32>, tensor<48x197x64xf32>) -> tensor<48x197x64xf32>
    ...
    %968 = tosa.add %960, %966 : (tensor<48x197x197xf32>, tensor<48x197x1xf32>) -> tensor<48x197x197xf32>
    ...
    %989 = tosa.mul %global8, %987 {shift = 0 : i8} : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
    ...
    %997 = tosa.add %992, %995 : (tensor<4x197x768xf32>, tensor<4x197x1xf32>) -> tensor<4x197x768xf32>
