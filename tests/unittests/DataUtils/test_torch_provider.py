...
#     config = ConfigLegacy(batch_size=32, dataset=DatasetType.MNIST, executor=ExecutorType.TORCH)
...
#     config = ConfigLegacy(batch_size=32, dataset=dataset, executor=ExecutorType.TORCH)
#     provider = DataProviderBuilder.build(config)
...
#     config = ConfigLegacy(batch_size=32, input_shape=(3, 224, 224), dataset=DatasetType.SYNTHETIC, executor=ExecutorType.TORCH)
#     provider = DataProviderBuilder.build(config)
#
#     num_batches = 5
#     count = 0
...
#     config = ConfigLegacy(batch_size=32, input_shape=(3, 224, 1), dataset=DatasetType.MNIST, executor=ExecutorType.TENSORFLOW)
#     provider = DataProviderBuilder.build(config)
#     data = provider.get_data()
#
...
#     config = ConfigLegacy(batch_size=32, input_shape=(3, 224, 224), dataset=DatasetType.SYNTHETIC, executor=ExecutorType.TENSORFLOW)
#     provider = DataProviderBuilder.build(config)
#
#     num_batches = 5
#     count = 0
...
#     config = ConfigLegacy(batch_size=32, input_shape=(28, 28), dataset=DatasetType.MNIST, executor=ExecutorType.TENSORFLOW)
#     provider = DataProviderBuilder.build(config)
#
#     num_batches = 5
#     count = 0
